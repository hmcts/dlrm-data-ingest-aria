...
locals {
  function_apps_import = {
    ...
    "00-af-aplfpa2" = "/subscriptions/df72bb30-d6fb-47bd-82ee-5eb87473ddb3/resourceGroups/ingest00-main-sbox/providers/Microsoft.Web/sites/af-aplfpa2-sbox00-uks-dlrm-01"
  }
}
