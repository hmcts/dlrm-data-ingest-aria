...
#     "curated_sas_token_00" = "https://ingest00-meta002-stg.vault.azure.net/secrets/CURATED-SAS-TOKEN/1"
...
#   id = "https://ingest00-meta002-stg.vault.azure.net/secrets/CURATED-stg-SAS-TOKEN/1"
# }
