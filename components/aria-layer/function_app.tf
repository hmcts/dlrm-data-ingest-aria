...
resource "azurerm_linux_function_app" "example" {
  ...
  storage_account_name       = data.azurerm_storage_account.xcutting[each.key].name               #azurerm_storage_account.example[each.key].name #use xcutting storage account 
  storage_account_access_key = data.azurerm_storage_account.xcutting[each.key].primary_access_key #azurerm_storage_account.example[each.key].primary_access_key
